            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <ul class="space-y-2 text-sm">
                        <li>
                            <a href="{{ route('about') }}"
                               ...
                               class="text-gray-300 hover:text-yellow transition">Tentang Kami</a>
                        </li>
                        <li>
                            <a href="{{ route('services') }}"
                               onclick="trackClick('footer', 'Link - Layanan');"
                               class="text-gray-300 hover:text-yellow transition">Layanan</a>
                        </li>
                        <li>
                            <a href="{{ route('programs') }}"
                               onclick="trackClick('footer', 'Link - Program Pelatihan');"
                               class="text-gray-300 hover:text-yellow transition">Program Pelatihan</a>
                        </li>
                        <li>
                            <a href="{{ route('contact') }}"
                               onclick="trackClick('footer', 'Link - Kontak');"
                               class="text-gray-300 hover:text-yellow transition">Kontak</a>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-300">
                        <li>Pelatihan AK3 Umum</li>
                        <li>Sertifikasi BNSP</li>
                        <li>Perpanjangan SKP</li>
                        <li>Pelatihan TOT BNSP</li>
                    </ul>
                </div>
                    ...
                    <ul class="space-y-3 text-sm">
                        <li class="flex items-start space-x-2">
                            ...
                            <span class="text-gray-300">
                                Jl. Cipto Mangunkusumo, Belimbing, Kec. Bontang Barat,
