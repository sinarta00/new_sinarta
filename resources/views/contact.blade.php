            ...
            <div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                <a href="tel:+6281351813731" 
                                   onclick="trackClick('contact_info', 'Click Phone - +6281351813731');"
                                   class="hover:text-maroon transition">+62 813-5181-3731</a><br>
                            </p>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                <a href="mailto:Marketing@sinartamjs.com" 
                                   onclick="trackClick('contact_info', 'Click Email - Marketing@sinartamjs.com');"
                                   class="hover:text-maroon transition">Marketing@sinartamjs.com</a><br>
                                <a href="mailto:admin@sinartamjs.com" 
                                   onclick="trackClick('contact_info', 'Click Email - admin@sinartamjs.com');"
                                   class="hover:text-maroon transition">admin@sinartamjs.com</a>
                            </p>
                        </div>
                    </div>
                ...
                <div class="mt-8">
                    ...
                    <div class="flex space-x-4">
                        <a href="#" 
                           onclick="trackClick('social_contact', 'Contact Page - Facebook');"
                           class="w-12 h-12 bg-maroon rounded-lg flex items-center justify-center hover:bg-maroon-dark transition">
                            <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                            </svg>
                        </a>
                        <a href="#" 
                           onclick="trackClick('social_contact', 'Contact Page - Instagram');"
                           class="w-12 h-12 bg-maroon rounded-lg flex items-center justify-center hover:bg-maroon-dark transition">
                            <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="#" 
                           onclick="trackClick('social_contact', 'Contact Page - LinkedIn');"
                           class="w-12 h-12 bg-maroon rounded-lg flex items-center justify-center hover:bg-maroon-dark transition">
                            <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="https://wa.me/6281234567890" 
                           target="_blank"
                           onclick="trackClick('whatsapp', 'Contact Page - WhatsApp Social');"
                           class="w-12 h-12 bg-green-500 rounded-lg flex items-center justify-center hover:bg-green-600 transition">
                            <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
    ...
    grecaptcha.ready(function() {
        grecaptcha.execute('{{ env('RECAPTCHA_SITE_KEY') }}', {action: 'contact'}).then(function(token) {
            ...
            if (typeof trackClick === 'function') {
                trackClick('contact_form', 'Submit - Contact Page');
            }
        ...
        <div class="max-w-4xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <a href="https://wa.me/6281351813731" 
                   target="_blank"
                   onclick="trackClick('quick_contact', 'WhatsApp CTA Button');"
                   class="bg-green-500 text-white rounded-xl p-6 hover:bg-green-600 transition group">
                ...
                <!-- Email -->
                <a href="mailto:info@sinartamjs.com" 
                   onclick="trackClick('quick_contact', 'Email CTA Button');"
                   class="bg-maroon text-white rounded-xl p-6 hover:bg-maroon-dark transition group">
                    <div class="flex items-center justify-center mb-4">
                        <div class="w-16 h-16 bg-white rounded-full flex items-center justify-center">
                ...
                <a href="tel:+6281234567890" 
                   onclick="trackClick('quick_contact', 'Phone CTA Button');"
                   class="bg-yellow text-maroon rounded-xl p-6 hover:bg-yellow-light transition group">
                    <div class="flex items-center justify-center mb-4">
                        <div class="w-16 h-16 bg-white rounded-full flex items-center justify-center">
