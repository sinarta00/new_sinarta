...
<div class="bg-gray-50 rounded-2xl p-8 shadow-lg">
    ...
    <form action="{{ route('contact.store') }}" method="POST" class="space-y-6" id="homeContactForm">
        @csrf
        
        <div>
            <label for="home_name" class="block text-sm font-semibold text-gray-900 mb-2">Nama Lengkap</label>
        ...
        <div>
            <label for="home_email" class="block text-sm font-semibold text-gray-900 mb-2">Email</label>
        ...
        <div>
            <label for="home_phone" class="block text-sm font-semibold text-gray-900 mb-2">No. Telepon</label>
        ...
        <div>
            <label for="home_program" class="block text-sm font-semibold text-gray-900 mb-2">Program yang Diminati</label>
            <select id="home_program" name="program"
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-maroon focus:border-transparent transition">
        ...
        <div>
            <label for="home_message" class="block text-sm font-semibold text-gray-900 mb-2">Pesan</label>
        ...
        <button type="submit" 
            ...
            <span id="homeBtnText">Kirim Pesan</span>
        </button>
    ...
    grecaptcha.ready(function() {
        grecaptcha.execute('{{ env('RECAPTCHA_SITE_KEY') }}', {action: 'contact'}).then(function(token) {
            ...
            if (typeof trackClick === 'function') {
                trackClick('contact_form', 'Submit - Homepage');
            }
