...
<section class="py-8 bg-white border-b">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <form method="GET" action="{{ route('programs') }}" class="flex flex-col md:flex-row gap-4">
            ...
            <!-- Search Button -->
            <button type="submit" class="bg-maroon text-white px-8 py-3 rounded-lg hover:bg-maroon-dark transition font-semibold">
                Cari
            </button>
            
            <!-- Reset -->
            @if(request('search') || request('category'))
            <a href="{{ route('programs') }}" class="bg-gray-200 text-gray-700 px-8 py-3 rounded-lg hover:bg-gray-300 transition font-semibold text-center">
                Reset
            </a>
            @endif
        </form>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @else
            <div class="text-center py-12">
                ...
                <a href="{{ route('programs') }}" class="inline-block bg-maroon text-white px-6 py-3 rounded-lg hover:bg-maroon-dark transition font-semibold">
                    Lihat Semua Program
                </a>
            </div>
        @endif
